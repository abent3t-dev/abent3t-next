...
export default function ExpeditacionPage() {
  ...
  const listQuery = useQuery({
    queryKey: ['expediting', search, statusFilter, onlyMine, page],
    queryFn: () =>
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div>
        ...
        <p className="text-gray-500">
          Seguimiento de entregas de órdenes de compra propias (las POs de
          Maximo no se expeditan desde ABENT)
        </p>
      </div>
                ...
                <tbody className="divide-y divide-gray-200">
                  {items.map((item, idx) => (
                    <tr
                      ...
                      onClick={() => setSelectedPoId(item.purchase_order_id)}
